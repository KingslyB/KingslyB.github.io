...
(function()
{
    ...
    function CheckLogin(): void
    {
        ...
        if(sessionStorage.getItem("user"))
        {
            $("#task-list").html(`<li class="nav-item" id="task-list">
                                 <a class="nav-link" href="#" data="task-list">
                                 <i class="fas fa-clipboard-check"></i> Tasks</a>
                                 </li>`);
            $("#task-list li a").on("click", function(){
                LoadLink("task-list");
            })
            ...
            $("#logout").on("click", function()
            {
                ...
                //remove task-list link
                $("#task-list").html(`<li class="nav-item id="task-list"> </li>`);
